...
<nav class="w3-sidenav w3-dark-grey w3-collapse w3-top w3-medium w3-padding w3-animate-left sidebarw3" style="z-index:1;width:200px;" id="mySidenav"><br>
  ...
  <div class="w3-container w3-margin-top w3-center w3-xlarge">
    <img src="logo.png" style="width:100%"/><br/>CSE
  </div>
  <a href="#about"		 onclick="w3_close()" class="w3-padding w3-hover-white w3-border-bottom">About CSE</a> 
...
<div class="w3-main" style="margin-left:250px;margin-right:20px">
  ...
  <div class="slider">
  <img src="images/cse/slider/slide1.jpg"/>
  <img src="images/cse/slider/slide2.jpg"/>
  <img src="images/cse/slider/slide3.jpg"/>
  <img src="images/cse/slider/slide4.jpg"/>
  </div>

   <div class="w3-container" id="about">
 
    <h1 class="w3-xlarge w3-text-red"><b>About CSE</b></h1>
    <hr style="width:100px;border:2px solid red" class="w3-round">
   <div class="w3-row w3-card-8 w3-round w3-padding-large">
	<div class="w3-col m4 l4">
		<img src="images/cse/hod/hod.jpg" style="width:100%;border-radius:50%;"/>
	</div>
		...
		M.Tech,M.Phil,(Ph.D.)</span><br/>
				mailto:<span class="w3-codespan">hodcse@cec.ac.in</span>
		<p class="w3-hide-small w3-align-left w3-medium w3-text-black">
	The Department of Computer science and Engineering was established in the year 2000 with an intake of 60 students. It was increased to 120 students in the academic year 2004-2005. Our Department offers B.Tech Computer science and Engineering, M.Tech Computer science and Engineering programs & Software Engineering. Highly qualified and experienced faculty with specialization in Data Mining, Image Processing, Software Engineering, Natural language processing, Web Technology, Network Technology and Distributed Computing are working in the department. All the class rooms are well furnished,with smart board facility. The department has 6 laboratories with air condition and internet facility. Totally 390 systems with higher configuration and smart boards are available in the Laboratories.
		</p>
...
<div class="w3-container" id="vision">
  ...
  To be the pioneering department in transforming the students as professionals to compete globally in all areas of Computer Science and to make significant contributions to the technical advancement in the field of Computer Science.
...
<div class="w3-container" id="mission">
  ...
  <p class="w3-border-bottom">To generate, reinforce and sharpen the scientific and engineering skills in the fields of hardware, software and networking in every student through a comprehensive teaching - learning process.<p>
  
	<p class="w3-border-bottom">To prepare the students for a prospective career in IT industry and for higher learning by imparting sound technical knowledge.</p>
...
<div class="w3-container" id="courses">
	...
	<span class="w3-medium w3-justify">
...
<tr class="w3-cyan w3-text-white">
  ...
  <th>1.</th><th>	Prof. M.Ramjee			</th><th>Principal</th><th> Ph.D.</th></tr><tr>  
  <th>2.</th><th>	Smt K.Valli Madhavi 	</th><th>Asso. Prof. , HOD		</th><th>M.Tech(Ph.D)</th></tr><tr>
  <th>3.</th><th>	Sri. P. Laxmi Kanth		</th><th>Asso. Prof.</th><th>	M.Tech.(Ph.D.)</th></tr><tr>
  <th>4.</th><th>	Sri. I.S.Srinivasa Rao	</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>5.</th><th>	Sri. B. Kishore 		</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>6.</th><th>	Sri. Y.Satishkumar		</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>7.</th><th>	Sri.P.V.S.N.Murthy		</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>8.</th><th>	Smt.M.Aswini 			</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>9.</th><th>	Smt.Ch.Kalyani			</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>10.</th><th>	Ms.M.Padmaja			</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>11.</th><th>	Mrs. P.Saipooja 		</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>12.</th><th>	P.Joshua rajau 			</th><th>Asst. Prof.</th><th>	M.Tech</th></tr><tr>
 ...
 <div class="w3-container" id="workshops">
    ...
    <hr style="width:100px;border:2px solid red" class="w3-round">
  	<?php
$i=0;
$myFile = "files/cse/workshops.txt";
...
{	
$folder_path = 'images/cse/labs/'.$arr[$i]; //image's folder path
