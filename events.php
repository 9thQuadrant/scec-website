...
<span class="w3-xxxlarge w3-text-blue w3-border-bottom w3-border-red"><?php echo $arr['marquee-'.$_GET['event']]; ?></span>
<img onerror="this.src='images/events/error.jpg'" src="images/events/<?php echo 'banner-'.$_GET['event']?>.jpg" width="100%"/>
<p class="w3-justify w3-padding w3-leftbar w3-rightbar w3-border-blue w3-pale-blue">
<?php echo $arr['description-'.$_GET['event']]; ?>
</p>

<div class="w3-padding-16">
<script>
check=<?php echo '"'.	trim($arr['participate-'.$_GET['event']])	.'";';?>
if(check!=='no'){
document.write('<a class="participate"><button class="w3-btn w3-card-4 w3-round w3-blue"><?php echo trim($arr['participate-'.$_GET['event']]); ?></button></a>');
}

$('table').addClass('w3-table w3-striped');
link =<?php echo '"'.trim($arr['link-'.$_GET['event']]).'"';?>;
$('.participate').attr('href',link);
</script>
