...
<div class="w3-top w3-cyan w3-card-4" style="z-index:3">
  <ul class="w3-navbar" id="myNavbar">
    ...
    <li class="w3-hide-small w3-white"><a class="w3-white" href="NSS.php">NSS</a></li>
...
<!-- Sidenav/menu -->
<nav class="w3-top w3-sidenav w3-collapse w3-padding w3-dark-grey w3-animate-left" style="z-index:1;width:200px;" id="mySidenav"><br/>
     <div class="w3-container w3-margin-top w3-center w3-xlarge">
    <img src="logo.png" width="100%"/><br/>NSS Gallery
  </div>
...
<div class="w3-container">
   <div class="w3-row w3-card-8 w3-round w3-white w3-padding-large">
	<div class="w3-col m4 l4">
		<img src="images/NSS/Laxmikanth.jpg" style="width:100%;border-radius:50%;"/>
	</div>
		<div class="w3-col m8 l8 w3-padding-large w3-align-left"> 
		<span class="w3-xlarge">NSS Programme Officer</span><br/>
		<span class="w3-large w3-border-bottom">Sri.P.Laxmikanth,<br/> M.Tech(Ph.D.) , Assoc. Prof.</span><br/>
				<span class="w3-codespan">Phone: 9849170207</span>
		<p class="w3-hide-small w3-align-left w3-medium w3-text-black">	</p>
...
for($i=0;$i<sizeof($arr);$i++)
{	
$folder_path = 'NSS/'.$arr[$i]; //image's folder path
