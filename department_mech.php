...
<nav class="w3-sidenav w3-dark-grey w3-collapse w3-top w3-medium w3-padding w3-animate-left sidebarw3" style="z-index:1;width:200px;" id="mySidenav"><br>
  ...
  <div class="w3-container w3-margin-top w3-center w3-xlarge">
		<img src="logo.png" style="width:100%"/><br/>MECH
	</div>
  <a href="#about"		 onclick="w3_close()" class="w3-padding w3-hover-white w3-border-bottom">About MECH</a> 
...
<div class="w3-main" style="margin-left:250px;margin-right:20px">
  ...
  <div class="slider">
  <img src="images/mech/slider/slide1.jpg"/>
  <img src="images/mech/slider/slide2.jpg"/>
  <img src="images/mech/slider/slide3.jpg"/>
  <img src="images/mech/slider/slide4.jpg"/>
  </div>

   <div class="w3-container" id="about">
 
    <h1 class="w3-xlarge w3-text-red"><b>About MECH</b></h1>
    <hr style="width:100px;border:2px solid red" class="w3-round">
   <div class="w3-row w3-card-8 w3-round w3-padding-large">
	<div class="w3-col m4 l4">
		<img src="images/mech/hod/hod.jpg" style="width:100%;border-radius:50%;"/>
	</div>
		<div class="w3-col m8 l8 w3-padding-large w3-align-left"> 
		<span class="w3-xlarge">HOD</span><br/>
		<span class="w3-large w3-border-bottom">Sri.I.R.K.Raju,<br/> M.Tech, Asso.Prof. &amp; HOD<br/>
				mailto:<span class="w3-codespan">hodmech@cec.ac.in</span></span>
		<p class="w3-hide-small w3-align-left w3-medium w3-text-black">
	Established in the year of 2003-2004 with an annual intake of 60 students. Intake has been further increased to  180 students from 2010-2011. The department is having fully experience senior faculty with post graduate degree and Ph.D registered / submitted faculty. Mechanical department has well equipped labs.
		</p>
...
To create an academic ambiance that encourages the full blossoming of the latent creative genius of every student and staff member in all areas pertaining to the science and art of mechanical engineering on a continual basis.  
  </div>
  </div>
...
<div class="w3-container" id="mission">
  ...
  <p>To instill, reinforce and hone the mathematical, scientific and technical skills in the students and staff through
			<br/>
			1) Both Conventional and innovative teaching-learning processes.<br/>
...
<br/>
 ...
 <!---------------->
  <div class="w3-container" id="faculty">
	...
	<table class="w3-table w3-card-8 w3-round w3-bordered w3-striped w3-hoverable">
<tr class="w3-cyan">
  <th>S No.</th><th>	Name of Faculty</th><th>	Designation</th><th>Qualification</th></tr><tr>
  
  <th>1.</th><th>	Sri I.R.K.Raju	</th><th>	 HOD			</th><th>	M.Tech</th></tr><tr>  
  <th>2.</th><th>	Sri. Prof. Padala Jagan Mohan Rao		</th><th>	Prof.		</th><th>	B.E (Mech), DIIT (SDC) 2yrs. Res.PG in IIT KGP MB</th></tr><tr>
  <th>3.</th><th>	Prof T.V.Subba rao		</th><th>	Prof.	</th><th>	M.Tech</th></tr><tr>
  <th>4.</th><th>	Sri.M.H.Sundaraiah			</th><th>	Asso. Prof.		</th><th>	B.Tech., MBA</th></tr><tr>
  <th>5.</th><th>	Sri.K.Srikanth				</th><th>	Asso. Prof.		</th><th>	M.Tech.</th></tr><tr>
  <th>6.</th><th>	Sri D.Sitaramaswamy		</th><th>	Asst. Prof.		</th><th>	M.Tech.</th></tr><tr>
  <th>7.</th><th>	Ms.Ch.Tejaswi				</th><th>	Asst. Prof.		</th><th>	M.Tech.</th></tr><tr>
  <th>8.</th><th>	Ms.V.Supriya				</th><th>	Asst. Prof.		</th><th>	M.E.</th></tr><tr>
  <th>9.</th><th>	Ms.M.Swapna				</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>10.</th><th>	Ms. N.Nalini				</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
 
  <th>11.</th><th>	Mr.Grace Sudheer Kiran	</th><th>Asst. Prof.		</th><th>B.Tech</th></tr><tr>  
  <th>12.</th><th>	Ms.B.Snehadeepika		</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>13.</th><th>	Ms.A.Swathi		</th><th>	Asst. Prof.	</th><th>	B.Tech</th></tr><tr>
  <th>14.</th><th>	Mrs.I.Vijaya Kumari			</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>15.</th><th>	Mr.O.Sampath Kumar				</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>16.</th><th>	Mr.L.V.G.Sravan Kumar	</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>17.</th><th>	Mr.B.Ramana Murthy				</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>18.</th><th>	Mrs.P.Santhi				</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>19.</th><th>	Mr.P.Naveen Srinivas			</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>20.</th><th>	Mr.I.Haribabu				</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>

  <th>21.</th><th>	Ms.M.Swapna	</th><th>	Asst. Prof.			</th><th>B.Tech</th></tr><tr>  
  <th>22.</th><th>	Sri P.Suresh		</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>23.</th><th>	Ms.N.G.Easther rani		</th><th>	Asst. Prof.	</th><th>	B.Tech</th></tr><tr>
  <th>24.</th><th>	Mr.A.Sandeep		</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>25.</th><th>	Mr.K.Ramakrishna				</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>26.</th><th>	Mr.G.Vikram	</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>27.</th><th>	Mr.B.Jaswanth Karthik			</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>28.</th><th>	Ms.Y.Jyothi				</th><th>	Asst. Prof.		</th><th>B.Tech</th></tr><tr>
  <th>29.</th><th>	Ms.T.Srestha			</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
  <th>30.</th><th>	Mr.G.Balaji Rao				</th><th>	Asst. Prof.		</th><th>	B.Tech</th></tr><tr>
 ...
 <div class="w3-container" id="workshops">
    ...
    <hr style="width:100px;border:2px solid red" class="w3-round">
 	...
 	<?php
$i=0;
$myFile = "files/mech/workshops.txt";
...
?>
  ...
  <div class="w3-container" id="labs">
    ...
    <hr style="width:100px;border:2px solid red" class="w3-round">
  <p class="w3-padding">This laboratory introduces the practical aspects of concepts learnt in the thermal stream of mechanical engineering. Internal and external combustion engines are studied in good detail. In addition, other important applications like air conditioning, refrigeration etc. are also studied.</p>

  <?php $arr =array();
	
	$folder2=$folder='images/mech/labs';
	$i=0;
