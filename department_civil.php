...
<nav class="w3-sidenav w3-dark-grey w3-collapse w3-top w3-medium w3-padding w3-animate-left sidebarw3" style="z-index:1;width:200px;" id="mySidenav"><br>
  ...
  <div class="w3-container w3-margin-top w3-center w3-xlarge">
    <img src="logo.png" width="100%"/><br/>CIVIL
  </div>
  <a href="#about" onClick="w3_close()" class="w3-padding w3-hover-white w3-border-bottom">About CIVIL</a> 
...
<div class="w3-main" style="margin-left:250px;margin-right:20px">
  ...
  <div class="slider">
  <img src="images/civil/slider/slide1.jpg"/>
  <img src="images/civil/slider/slide2.jpg"/>
  <img src="images/civil/slider/slide3.jpg"/>
  <img src="images/civil/slider/slide4.jpg"/>
  </div>

   <div class="w3-container" id="about">
 
    <h1 class="w3-xlarge w3-text-red"><b>About CIVIL</b></h1>
    <hr style="width:100px;border:2px solid red" class="w3-round">
   <div class="w3-row w3-card-8 w3-round w3-padding-large">
	<div class="w3-col m4 l4">
		<img src="images/civil/hod/hod.jpg" style="width:100%;border-radius:50%;"/>
	</div>
		<div class="w3-col m8 l8 w3-padding-large w3-align-left"> 
		<span class="w3-xlarge">HOD</span><br/>
		<span class="w3-large w3-border-bottom">Sri D.G.K Varma, <br/>
		B.E, M.A, DAAC</span><br/>
				mailto:<span class="w3-codespan">hodce@cec.ac.in</span>
...
To create a highly reputed civil engineering department in india with creative and innovative faculty nurturing students in occupying highly coveted positions in the country and abroad and delivering qualitative consultancy to industry.  </div>
  </div>
...
<div class="w3-container" id="mission">
  ...
  <p>To reinforce high skill-set among staff and students through
<br>
A)    Effective  innovative teaching learning process<br>
B)    Consultancy<br>
C)    In-site training<br>
D)    Research <br>
E)    Interaction with reputed teaching institutes and consultancy organizations <br>
F)    Societal responsibility
<p>
  </div>
  </div>
...
<tr class="w3-cyan">
  ...
  <th>1.</th><th>	Sri. D.G.K.Varma	</th><th>Prof., HOD</th><th>	B.E, M.A, DAAC</th></tr><tr>  
  <th>2.</th><th>	Dr.K.R.M.Raju </th><th>	Prof.	</th><th>Msc (geo)M.Phil , Ph.D</th></tr><tr>
  <th>3.</th><th>	 Ms.Sana L.D.Samravi</th><th>	Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>4.</th><th>	B Bhargavi </th><th>	Asst. Prof.</th><th>	B.Tech.</th></tr><tr>
  <th>5.</th><th>	 Ms.S.Indu	</th><th>Asst. Prof.</th><th>	B.Tech.</th></tr><tr>
  <th>6.</th><th>	 Ms.Ch.A. Mounica	</th><th>Asst. Prof.	</th><th>M.Tech.</th></tr><tr>
  <th>7.</th><th>	 Ms.Priyanka	</th><th>Asst. Prof.	</th><th>B.Tech.</th></tr><tr>
  <th>8.</th><th>	 Ms.Rosy	</th><th>Asst. Prof.	</th><th>B.Tech.</th></tr><tr>
  <th>9.</th><th>	 Mr. T.S.D Phanidranath	</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>10.</th><th>	 Ms.B.Madhuri	</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>11.</th><th>	 Ms.S.Shilpa</th><th>	Asst. Prof.	</th><th>B.Tech.</th></tr><tr>
  <th>12.</th><th>	 Ms.P.Akhila	</th><th>Asst. Prof.</th><th>	M.Tech.</th></tr><tr>
  <th>13.</th><th>	 Sri.S.Sanyasi Rao	</th><th>Asso. Prof.	</th><th>B.Tech.</th></tr>
 ...
 <div class="w3-container" id="workshops">
	...
	<?php
$i=0;
$myFile = "files/civil/workshops.txt";
...
<?php $arr =array();
	...
	$folder2=$folder='images/civil/labs';
	$i=0;
...
<div class="w3-light-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px"><p class="w3-right">Powered by<br/><img src="images/logo/logo.png"/></p></div>
 ...
 <!-- Modal for full size images on click-->
  <div id="modal01" class="w3-modal w3-padding-0" style="background-color:rgba(0,0,0,0.8)" onClick="$(this).fadeOut(200)">
    <span class="w3-text-white w3-opacity w3-hover-opacity-off w3-xlarge w3-container w3-display-topright">×</span>
    <div class="w3-modal-content w3-animate-bottom w3-center w3-transparent w3-padding-64">
      <img id="img01" class="w3-image w3-round">
      <p id="caption"></p>
    </div>
  </div>
